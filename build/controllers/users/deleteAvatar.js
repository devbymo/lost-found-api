...
var removeAvatar = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = req.userId;
                if (!userId) {
                    return [2 /*return*/, next(new httpError_1.default('You are not authenticated!', 400))];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
