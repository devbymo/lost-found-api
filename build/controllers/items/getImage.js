...
var getAvatar = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                item = (_b.sent());
                if (!item) {
                    return [2 /*return*/, next(new httpError_1.default('Item does not exist', 400))];
                }
                if (!((_a = item.image) === null || _a === void 0 ? void 0 : _a.toString('base64'))) {
                    return [2 /*return*/, next(new httpError_1.default('Item does not have an image', 400))];
                }
