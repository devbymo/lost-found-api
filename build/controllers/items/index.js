...
var index = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validCategories, page, limit, sortBy, validSorts, order, validOrders, items, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                validCategories = ['mobile', 'laptop', 'keys', 'id', 'document', 'money', 'other'];
                if (req.body.category && !validator_1.default.isIn(req.body.category.toLowerCase(), validCategories)) {
                    return [2 /*return*/, next(new httpError_1.default('Invalid category passed', 400))];
                }
                // Validate country if passed
                if (req.body.country && !validator_1.default.isLength(req.body.country, { min: 2, max: 50 })) {
                    return [2 /*return*/, next(new httpError_1.default('Country must be at least 2 characters', 400))];
                }
                // Validate city if passed
                if (req.body.city && !validator_1.default.isLength(req.body.city, { min: 2, max: 50 })) {
                    return [2 /*return*/, next(new httpError_1.default('City must be at least 2 characters', 400))];
                }
                // Validate name if passed
                if (req.body.name && !validator_1.default.isLength(req.body.name, { min: 2, max: 50 })) {
            ...
            case 1:
                _a.trys.push([1, 6, , 7]);
                items = [];
                if (!(req.body.category || req.body.country || req.body.city || req.body.name)) return [3 /*break*/, 3];
                return [4 /*yield*/, item_1.default.find(__assign(__assign(__assign({}, (req.body.category && { category: req.body.category.toLowerCase() })), (req.body.country && { country: req.body.country.toLowerCase() })), (req.body.city && { city: req.body.city.toLowerCase() })))
                        .skip((page - 1) * limit)
                        .limit(limit)
            ...
            case 2:
                items = _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, item_1.default.find()
                    .skip((page - 1) * limit)
                    .limit(limit)
                    .sort([[sortBy, order === 'asc' ? 1 : -1]])];
            case 4:
