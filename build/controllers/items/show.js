...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var itemId, item, itemData, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                itemData = __assign(__assign({}, item.toObject({ getters: true })), { image: "".concat(process.env.NODE_ENV === 'dev' ? process.env.DEV_URL : process.env.PROD_URL, "/api/v1/items/").concat(item.id, "/image") });
                res.status(200).json({
                    status: 'success',
